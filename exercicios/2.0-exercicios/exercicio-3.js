...
function salary(hoursWorked, salaryHours){

    const salaryGross = hoursWorked * salaryHours
    const salaryLiquid = salaryGross - salaryGross * 30/(100)

    return `Salário igual a R$ ${salaryLiquid}`

}

console.log(salary(180, 60))